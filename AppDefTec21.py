...
data_train=pathlib.Path('seg_train/seg_train')
data_test=pathlib.Path('seg_test/seg_test')
# Cargar imágenes
...
def crear_modelo(filtros, tamaño, pool_size, neuronas,train_generator,validation_generator):
...
def train_page():
  ...
  # Cargar imágenes
  train_generator, validation_generator = data_train,data_test
  ...
  # Crear y entrenar modelo
    if data_train is not None and data_test is not None:
      model, history = crear_modelo(num_filters, filter_size, pool_size, num_neurons,train_generator,validation_generator)
